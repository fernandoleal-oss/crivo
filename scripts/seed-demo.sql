...
INSERT INTO comments (id, piece_id, version_id, author_name, content, comment_type, pin_x, pin_y, is_internal, created_at) VALUES
  ('cc000001-0001-0001-0000-000000000001', 'aa000001-0000-0000-0000-000000000001', 'ee000001-0001-0000-0000-000000000001',
  ...
  ('cc000001-0001-0002-0000-000000000001', 'aa000001-0000-0000-0000-000000000001', 'ee000001-0001-0000-0000-000000000002',
  ...
  ('cc000001-0001-0003-0000-000000000001', 'aa000001-0000-0000-0000-000000000001', 'ee000001-0001-0000-0000-000000000003',
  ...
  ('cc000001-0001-0003-0000-000000000002', 'aa000001-0000-0000-0000-000000000001', 'ee000001-0001-0000-0000-000000000003',
...
INSERT INTO comments (id, piece_id, version_id, author_name, content, comment_type, pin_x, pin_y, is_internal, created_at) VALUES
  ('cc000001-0002-0001-0000-000000000001', 'aa000001-0000-0000-0000-000000000002', 'ee000001-0002-0000-0000-000000000001',
  ...
  ('cc000001-0002-0002-0000-000000000001', 'aa000001-0000-0000-0000-000000000002', 'ee000001-0002-0000-0000-000000000002',
  ...
  ('cc000001-0002-0002-0000-000000000002', 'aa000001-0000-0000-0000-000000000002', 'ee000001-0002-0000-0000-000000000002',
...
INSERT INTO comments (id, piece_id, version_id, author_name, content, comment_type, pin_x, pin_y, is_internal, created_at) VALUES
  ('cc000002-0001-0001-0000-000000000001', 'aa000002-0000-0000-0000-000000000001', 'ee000002-0001-0000-0000-000000000001',
  ...
  ('cc000002-0001-0001-0000-000000000002', 'aa000002-0000-0000-0000-000000000001', 'ee000002-0001-0000-0000-000000000001',
   'Rodrigo Lima', 'Espaçamento entre ícone e texto correto ✓', 'pin', 45.0, 50.0, false, NOW() - INTERVAL '6 days');

-- Paleta Nubank v2 (revisão)
INSERT INTO comments (id, piece_id, version_id, author_name, content, comment_type, pin_x, pin_y, is_internal, created_at) VALUES
  ('cc000002-0002-0001-0000-000000000001', 'aa000002-0000-0000-0000-000000000002', 'ee000002-0002-0000-0000-000000000001',
  ...
  ('cc000002-0002-0002-0000-000000000001', 'aa000002-0000-0000-0000-000000000002', 'ee000002-0002-0000-0000-000000000002',
...
INSERT INTO comments (id, piece_id, version_id, author_name, content, comment_type, pin_x, pin_y, is_internal, created_at) VALUES
  ('cc000003-0001-0001-0000-000000000001', 'aa000003-0000-0000-0000-000000000001', 'ee000003-0001-0000-0000-000000000001',
  ...
  ('cc000003-0001-0002-0000-000000000001', 'aa000003-0000-0000-0000-000000000001', 'ee000003-0001-0000-0000-000000000002',
  ...
  ('cc000003-0001-0003-0000-000000000001', 'aa000003-0000-0000-0000-000000000001', 'ee000003-0001-0000-0000-000000000003',
   'Fernanda Castro', 'Isso sim! Aprovado. Pode subir para produção.', 'general', NULL, NULL, false, NOW() - INTERVAL '2 days');

-- Push Magalu (revisão)
INSERT INTO comments (id, piece_id, version_id, author_name, content, comment_type, pin_x, pin_y, is_internal, created_at) VALUES
  ('cc000003-0002-0001-0000-000000000001', 'aa000003-0000-0000-0000-000000000002', 'ee000003-0002-0000-0000-000000000001',
...
INSERT INTO comments (id, piece_id, version_id, author_name, content, comment_type, pin_x, pin_y, is_internal, created_at) VALUES
  ('cc000004-0001-0001-0000-000000000001', 'aa000004-0000-0000-0000-000000000001', 'ee000004-0001-0000-0000-000000000001',
  ...
  ('cc000004-0001-0001-0000-000000000002', 'aa000004-0000-0000-0000-000000000001', 'ee000004-0001-0000-0000-000000000001',
...
INSERT INTO approvals (id, piece_id, version_id, decision, feedback, decided_by, decided_at) VALUES
  ('a0000001-0001-0000-0000-000000000001', 'aa000001-0000-0000-0000-000000000001', 'ee000001-0001-0000-0000-000000000003',
...
INSERT INTO approvals (id, piece_id, version_id, decision, feedback, decided_by, decided_at) VALUES
  ('a0000001-0002-0000-0000-000000000001', 'aa000001-0000-0000-0000-000000000002', 'ee000001-0002-0000-0000-000000000002',
...
INSERT INTO approvals (id, piece_id, version_id, decision, feedback, decided_by, decided_at) VALUES
  ('a0000001-0004-0000-0000-000000000001', 'aa000001-0000-0000-0000-000000000004', 'ee000001-0004-0000-0000-000000000001',
   'approved', 'Template aprovado. Pode disparar para a base.', 'Marcos Ribeiro', NOW() - INTERVAL '7 days');

-- Logo Nubank aprovado
INSERT INTO approvals (id, piece_id, version_id, decision, feedback, decided_by, decided_at) VALUES
  ('a0000002-0001-0000-0000-000000000001', 'aa000002-0000-0000-0000-000000000001', 'ee000002-0001-0000-0000-000000000001',
...
INSERT INTO approvals (id, piece_id, version_id, decision, feedback, decided_by, decided_at) VALUES
  ('a0000002-0002-0000-0000-000000000001', 'aa000002-0000-0000-0000-000000000002', 'ee000002-0002-0000-0000-000000000002',
...
INSERT INTO approvals (id, piece_id, version_id, decision, feedback, decided_by, decided_at) VALUES
  ('a0000003-0001-0000-0000-000000000001', 'aa000003-0000-0000-0000-000000000001', 'ee000003-0001-0000-0000-000000000003',
   'approved', 'Na terceira foi! Está com energia e clareza. Sobe para produção.', 'Fernanda Castro', NOW() - INTERVAL '2 days');

-- Push Magalu revisão
INSERT INTO approvals (id, piece_id, version_id, decision, feedback, decided_by, decided_at) VALUES
  ('a0000003-0002-0000-0000-000000000001', 'aa000003-0000-0000-0000-000000000002', 'ee000003-0002-0000-0000-000000000001',
...
-- Key Visual Natura aprovado
INSERT INTO approvals (id, piece_id, version_id, decision, feedback, decided_by, decided_at) VALUES
  ('a0000004-0001-0000-0000-000000000001', 'aa000004-0000-0000-0000-000000000001', 'ee000004-0001-0000-0000-000000000001',
